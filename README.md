...
- \[2023.11.05\] Upgrade the logic of `remap_mscoco_category` to facilitate training of custom datasets, see detils in [*Train custom data*](stqsdetr_pytorch/) part. [#81](https://github.com/lyuwenyu/RT-DETR/commit/95fc522fd7cf26c64ffd2ad0c622c392d29a9ebf).
...
- \[2023.08.22\] Upload ✅ [*rtdetr_pytorch*](stqsdetr_pytorch/) source code. Please enjoy it!
...
- 🔥 RT-DETR 
  ...
  - pytorch: [code&weight](stqsdetr_pytorch)
