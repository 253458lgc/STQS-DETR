"""
reference: 
https://github.com/facebookresearch/stqsdetr/blob/main/models/stqsdetr.py
...
class SetCriterion(nn.Module):
    """ This class computes the loss for STQSDETR.
    ...
    def forward(self, outputs, targets):
        ...
        # In case of cdn auxiliary losses. For stqsdetr
