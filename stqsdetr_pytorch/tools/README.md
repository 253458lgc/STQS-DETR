...
- `torchrun --master_port=8844 --nproc_per_node=4 tools/train.py -c configs/stqsdetr/stqsdetr_r18vd_6x_coco.yml -t https://github.com/lyuwenyu/storage/releases/download/v0.1/stqsdetr_r18vd_5x_coco_objects365_from_paddle.pth` 
